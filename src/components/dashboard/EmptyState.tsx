...
export default function EmptyState({ 
  ...
  buttonText = "Create First Record"
}: EmptyStateProps) {
  return (
    <div className="bg-white rounded-[24px] border border-[#E2E8F0] shadow-sm min-h-[500px] flex flex-col items-center justify-center p-12 text-center">
      <div className="w-24 h-24 rounded-full bg-[#F8FAFC] flex items-center justify-center mb-6">
        <PackageOpen className="w-12 h-12 text-[#94A3B8]" strokeWidth={1.5} />
      </div>
